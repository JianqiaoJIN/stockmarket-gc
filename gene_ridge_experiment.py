...
if mbsize is None:
	...
	batchsize = mbsize
experiment_name = 'Experiments/Genetics/Ridge/expt'
experiment_name += '_lam-%e_lr=%e_opt-%s_batch-%d_seed-%d_nepoch-%d.out' % (lam, lr, opt, batchsize, seed, nepoch)
print(experiment_name)

# Create directory, if necessary
if not os.path.exists('Experiments/Genetics/Ridge'):
     os.makedirs('Experiments/Genetics/Ridge')
...
# Prepare model
model = RidgeNetwork(p_in, p_out, hidden_units, lr, opt, lam, nonlinearity = 'sigmoid', task = 'classification')
