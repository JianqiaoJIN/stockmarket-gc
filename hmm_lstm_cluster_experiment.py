...
# Prepare filename
experiment_name = 'Experiments/LSTM/HMM Encoding/expt'
experiment_name += '_lam=%e_nepoch=%d_lr=%e_seed-%d.out' % (lam, nepoch, lr, seed)

# Create directory, if necessary
if not os.path.exists('Experiments/LSTM/HMM Encoding'):
     os.makedirs('Experiments/LSTM/HMM Encoding')
